...
values (1, 'f9981ca4-5a5e-4da3-af04-933861df3e55', 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (restaurante_id, codigo, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
	                status, data_criacao, subtotal, taxa_frete, valor_total)
values (4, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab', 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
