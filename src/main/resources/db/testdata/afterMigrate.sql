...
LOCK TABLE cidade IN EXCLUSIVE MODE;
LOCK TABLE cozinha IN EXCLUSIVE MODE;
LOCK TABLE estado IN EXCLUSIVE MODE;
LOCK TABLE forma_pagamento IN EXCLUSIVE MODE;
LOCK TABLE grupo IN EXCLUSIVE MODE;
LOCK TABLE grupo_permissao IN EXCLUSIVE MODE;
LOCK TABLE permissao IN EXCLUSIVE MODE;
LOCK TABLE produto IN EXCLUSIVE MODE;
LOCK TABLE restaurante IN EXCLUSIVE MODE;
LOCK TABLE restaurante_forma_pagamento IN EXCLUSIVE MODE;
LOCK TABLE usuario IN EXCLUSIVE MODE;
LOCK TABLE usuario_grupo IN EXCLUSIVE MODE;
LOCK TABLE item_pedido IN EXCLUSIVE MODE;
LOCK TABLE foto_produto IN EXCLUSIVE MODE;
LOCK TABLE oauth2_registered_client IN EXCLUSIVE MODE;
