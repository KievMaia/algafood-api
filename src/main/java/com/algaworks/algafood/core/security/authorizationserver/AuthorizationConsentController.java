...
public class AuthorizationConsentController {
	...
	public String consent(
		...
		if (client == null) {
			throw new AccessDeniedException(String.format("Cliente de %s não foi encontrado", client));
		}
		
		OAuth2AuthorizationConsent consent = this.consentService.findById(client.getId(), princial.getName());
		...
		model.addAttribute("principalName", princial.getName());
