...
public class AlgaSecurity {
	...
	public boolean podePesquisarPedidos(Long clientId, Long restauranteId) {
		return temEscopoLeitura() && (hasAuthority("CONSULTAR_PEDIDOS") || usuarioAutenticadoIgual(clientId) || gerenciaRestaurante(restauranteId));
	}
