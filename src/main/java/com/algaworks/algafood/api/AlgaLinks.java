...
public class AlgaLinks {
	...
	public Link linkToPedidos() {
		...
		return Link.of(UriTemplate.of(pedidosUrl, PAGINACAO_VARIBLES.concat(filtroVariables)), "pedidos");
	}
	...
	public Link linkToProduto(Long restauranteId, Long produtoId) {
		return linkTo(methodOn(RestauranteProdutosController.class).buscar(restauranteId, produtoId)).withRel("produto");
	}
